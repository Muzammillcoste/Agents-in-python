...
1. **Word2Vec**: A popular method that uses neural networks to learn word associations from a large corpus of text. It produces two types of embeddings: Continuous Bag of Words (CBOW) and Skip-gram.
